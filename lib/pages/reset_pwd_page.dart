...
class _ResetCodePageState extends State<ResetCodePage> {
  ...
  void _sendCode(){
    Map<String, String> sendSmsHeaders = {'method': 'userForgetPasswordSendSmsIdentifyingCode'};
    Map<String, String> sendSmsParams = {'mobile': widget.phoneNum};
    _httpUtils.request(sendSmsHeaders, sendSmsParams).then((data) {
      try {
